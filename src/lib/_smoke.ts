 ...
 * 3. The path alias `@lib/*` resolves in test imports
 *
...
/**
 * Returns the build-time string identifying which  * file resolution served this module. Tests assert this signature
